...
<h4>checkpoint</h4>
<p> Functional interface attempt done. prog still works. 
Have to thing about a generic application on the translator class to replace 
the switch statement? also recap on dependency Injection in combo with reflection</p>